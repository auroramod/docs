...
### How to run IW7-Mod via Proton

First, you are going to need [Steam](https://store.steampowered.com/) installed. To do so, you can open a Terminal run the following command:
...
Once **Steam** is installed, you can now open up and head over to your **Library**. At the bottom of the Library, we are going to click `Add a Non-Steam Game...`.
